            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form class="forms-sample" action="/pengguna" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" autofocus required class="form-control" name="role" value="{{$pengguna->role}}" placeholder="Masukan Role...">
                            </div>
                            <div class="form-group">
