...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Booking HairCut</h1>
        <ol class="breadcrumb">
                    ...
                    <table class="table align-items-center table-flush" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!-- Tambahkan tombol cetak pada setiap baris data -->
                                <td>
                                    ...
                                    <button class="btn btn-success btn-sm mt-2" onclick="cetakStruk({{ $booking_cut->id}})">Cetak Struk</button>
                                </td>
                            </tr>
                            @empty
                            <td colspan="13"> data tidak ada
                            </td>
                            @endforelse
                        </tbody>
                    </table>
...
<script>
    function cetakStruk(bookingId) {
        // Menggunakan window.print() untuk mencetak struk
        window.open(`/cetak-struk/${bookingId}`, '_blank');
    }
</script>
