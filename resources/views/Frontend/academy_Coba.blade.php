			...
			<div class="row align-items-center">
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light">
						<a class="navbar-brand" href="index.html"> <img src="images/logo_HC.png" alt="logo"> </a>
			...
			<div class="section-top-border text-right">
				...
				<div class="row">
					...
					<div class="col-md-2 mx-3">
						<img src="images/hh1.png" class="pt-3" alt="" class="img-fluid">
						<img src="img/elements/d.jpg" class="pt-3" alt="" class="img-fluid">
						<img src="img/elements/d.jpg" class="pt-3" alt="" class="img-fluid">
					</div>
				</div>
			</div>
